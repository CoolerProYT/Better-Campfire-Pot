...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(@NotNull RecipeOutput recipeOutput) {
        // Vanilla to Copper
        BetterCampfirePot.CAMPFIRE_POT_ITEMS.stream().filter(BetterCampfirePot::filterCopperTier).forEach(item -> {
        ...
        // Copper to Iron
        BetterCampfirePot.CAMPFIRE_POT_ITEMS.stream().filter(BetterCampfirePot::filterIronTier).forEach(item -> {
        ...
        // Iron to Gold
        BetterCampfirePot.CAMPFIRE_POT_ITEMS.stream().filter(BetterCampfirePot::filterGoldTier).forEach(item -> {
        ...
        // Gold to Diamond
        BetterCampfirePot.CAMPFIRE_POT_ITEMS.stream().filter(BetterCampfirePot::filterDiamondTier).forEach(item -> {
        ...
        // Diamond to Emerald
        BetterCampfirePot.CAMPFIRE_POT_ITEMS.stream().filter(BetterCampfirePot::filterEmeraldTier).forEach(item -> {
        ...
        BetterCampfirePot.CAMPFIRE_POT_ITEMS.stream().filter(BetterCampfirePot::filterNetheriteTier).forEach(item -> {
        ...
        BetterCampfirePot.TIER_UPGRADES.stream().forEach(item -> {
            Item from;
