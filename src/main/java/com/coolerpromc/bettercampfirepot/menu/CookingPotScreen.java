...
public class CookingPotScreen extends AbstractContainerScreen<CookingPotMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        blitWithBorder(guiGraphics, GUI, leftPos + imageWidth - 1, topPos + 20, 0, 0, 30, 30, 24, 24, 4);
        blitWithBorder(guiGraphics, GUI, leftPos - 29, topPos + 20, 0, 0, 30, 52, 24, 24, 4);
        if (toggleConfigButton.isToggled()){
            blitWithBorder(guiGraphics, GUI, leftPos + imageWidth - 1, topPos + 50, 24, 0, 30, 30, 24, 24, 4);
        }
    }
